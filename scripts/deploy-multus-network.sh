...
HELM_CHARTS_GIT_URL="https://github.com/k8snetworkplumbingwg/helm-charts.git"
...
then
  ...
  # rm -rf ./temp
  # git clone $MULTUS_GIT_URL --depth 1 -b v3.9.1 ./temp/multus-cni
  # # cd ./temp/multus-cni/e2e
  # # ./get_tools.sh
  # # ./generate_yamls.sh
  # # cd $SCRIPT_DIR
